...
*/
    ...
    /* (non-Javadoc)
     * @see org.noerp.widget.menu.MenuStringRenderer#renderMenuClose(java.io.Writer, java.util.Map, org.noerp.widget.menu.ModelMenu)
     */
    ...
    public void renderImage(Appendable writer, Map<String, Object> context, Image image) throws IOException {
        ...
        if (UtilValidate.isNotEmpty(src)) {
            ...
            HttpServletResponse response = (HttpServletResponse) context.get("response");
            HttpServletRequest request = (HttpServletRequest) context.get("request");
            if (urlMode != null && urlMode.equalsIgnoreCase("noerp")) {
